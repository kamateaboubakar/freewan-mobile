...
class DetailVehiculePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<DetailVehiculePageVctl>(
        init: DetailVehiculePageVctl(vehicule),
        builder: (ctl) {
          return Scaffold(
            appBar: AppBar(
            ...
            bottomNavigationBar: Padding(
              ...
              child: CButton(
                height: 50,
                onPressed: () =>
                    Get.to(() => DetailLocationVehiculePage(vehicule)),
                ...
                children: [
                  ...
                  (ctl.propritaire == null)
                      ...
                      : ListTile(
                          ...
                          title: Text(ctl.propritaire!.fullName),
                            ...
                            children: [
                              Row(
                                ...
                                children: [
                                  ...
                                  Text(vehicule.propietaireVehicule?.rating ??
                                      "0"),
                                ],
                              ),
                              const Text("(0 votes)")
                                  ...
                                  children: [
                                    Expanded(
                                      child: ListTile(
                                        ...
                                        title:
                                            Text(vehicule.transmission.value),
                                      ),
                                    ),
                                    Expanded(
                                      child: ListTile(
