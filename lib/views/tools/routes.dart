...
class Routes {
  static final List<RouteItem> _routes = [
    ...
    RouteItem(
      groupe: "Finance",
      button: ButtonMenu(
        icon: Image.asset("assets/images/icons/icons8-etudiant-homme-64.png"),
        title: "Scolarité",
    ...
    RouteItem(
      ...
      button: ButtonMenu(
        icon:
            Image.asset("assets/images/icons/icons8-google-play-store-96.png"),
  ...
  static List<RouteItem> routes({List<MenuButtonEnum> menus = const []}) =>
      _routes.where((e) => menus.contains(e.menuButtonEnum)).toList();

  static List<RouteItem> routesByGroup({String? groupe}) => _routes
      .where((e) => e.groupe.value.isNotEmpty)
      .where((e) => e.groupe == groupe)
      .toList();

  static List<RouteItem> search({String? value}) => _routes
  ...
  static List<String> get groupes => _routes
      .where((e) => e.groupe.value.isNotEmpty)
