...
List<JobEntity> get jobs => [
      JobEntity(
        ...
        iconBackgroundColor: Color(0xff34A853).withOpacity(0.1),
      ...
      JobEntity(
        ...
        iconBackgroundColor: Color(0xff236CF6).withOpacity(0.1),
      ...
      JobEntity(
        ...
        salary: "FCFA 500 000 / Mo",
        iconBackgroundColor: Color(0xffE31E52).withOpacity(0.1),
      ...
      JobEntity(
        ...
        jobTitle: "UX Writer",
        salary: "FCFA 500 000 / Mo",
        iconBackgroundColor: Color(0xff00AA13).withOpacity(0.1),
      ...
      JobEntity(
        ...
        jobTitle: "FE Developer",
        salary: "FCFA 500 000 / Mo",
        iconBackgroundColor: Color(0xff00ACED).withOpacity(0.1),
